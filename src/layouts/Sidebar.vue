...
import Langues from "./sidebar/Langues.vue";
import Interets from "./sidebar/Interets.vue";

</script>

<template>
  <div class="bg-sidebar flex flex-col pl-4 pr-3 p-2 text-white border-r-4 border-sidebar">
